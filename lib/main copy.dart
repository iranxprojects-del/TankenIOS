...
Future<void> _performSearch() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _selectedIndex == 0
          ...
          ? Column(
              children: [
                // اگر تحلیل نفت آماده بود، بنر رو نشون بده
                if (oilAnalysis != null) _buildOilBanner(), 
                
                // بقیه محتویات صفحه بنزین (نقشه و لیست)
  ...
  if (oilAnalysis == null) return const SizedBox();
  ...
  return Container(
    ...
    child: Row(
      children: [
        ...
        const SizedBox(width: 8),
        // Gheymat-e Asli (Emruz)
        Text(
          "Brent: \$${oilAnalysis!['today']}",
          style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
        ),
        const Spacer(),
        // Gheymat-haye ghabli ba size koochik
        Column(
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            Text(
              "Yesterday: \$${oilAnalysis!['yesterday']}",
              style: const TextStyle(fontSize: 10, color: Colors.grey),
            ),
            Text(
              "2 Days Before: \$${oilAnalysis!['dayBefore']}",
              style: const TextStyle(fontSize: 10, color: Colors.grey),
            ),
          ],
        ),
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              labelText: 'Search postal code / place',
              hintText: 'e.g. 10115 or Berlin Mitte',
            ...
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: Text(isSearchLoading ? 'Searching...' : 'Search'),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
          ...
          if (searchHistory.isNotEmpty) ...[
            ...
            Wrap(
              ...
              children: searchHistory.map((history) => ActionChip(
                label: Text(history, style: const TextStyle(fontSize: 11)),
                onPressed: () {
  ...
  Widget _buildProfessionalMap() {
    ...
    return SizedBox(
      ...
      child: FlutterMap(
        ...
        options: MapOptions(
          // مرکز نقشه رو گذاشتم روی لوکیشن خودت که بهتر ببینی کجایی
        ...
        children: [
          ...
          MarkerLayer(
            markers: [
              ...
              // ۲. اضافه کردن لیست ایستگاه‌ها با علامت ... (Spread Operator)
              ...stations.map((s) {
                return Marker(
                  width: 90,
                  height: 45,
              ...
              }).toList(), // تبدیل مپ به لیست و پخش کردن با ...
            ],
          ),
        ],
      ),
