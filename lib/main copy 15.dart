                          ...
                          Row(
                            children: [
                              GestureDetector(
                                ...
                                child: Icon(
                                  item.alarmEnabled 
                                      ? Icons.notifications_active // زنگوله فعال و در حال زنگ زدن
                                      : Icons.notifications_off,   // زنگوله خط خورده یا خاموش
                                  size: 22, // سایز زنگوله (می‌توانید کم و زیاد کنید)
                                  color: item.alarmEnabled 
                                      ? Colors.amber.shade700 // رنگ زنگوله فعال
                                      : Colors.grey.shade400, // رنگ زنگوله غیرفعال
                                ),                              
                              ),
