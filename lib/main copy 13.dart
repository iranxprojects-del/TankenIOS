            ...
            rows: displayItems.asMap().entries.map((entry) {
              ...
              return DataRow(
                ...
                cells: [
                  ...
                  DataCell(
  SizedBox(
    width: 100, // می‌توانید عرض را به دلخواه (مثلاً ۱۴۰ یا بیشتر) تنظیم کنید تا فیلد متنی فضای کافی داشته باشد
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.min,
      children: [
        // سطر اول: عنوان نگهداری/تعمیر
        Text(
        ...
        SizedBox(
          width: 80,
        // سطر دوم: فیلد متنی کیلومتر (Mileage)
        child: TextField(
          keyboardType: TextInputType.number,
          decoration: InputDecoration(
            isDense: true,
