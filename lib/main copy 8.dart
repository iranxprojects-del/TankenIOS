...
void _showTankenPremiumDialog(BuildContext context) {
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
        title: const Text('ارتقا به نسخه پرمیوم', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
        content: const Text(
          'مهلت استفاده رایگان شما به پایان رسیده است. برای مشاهده قیمت لحظه‌ای پمپ بنزین‌ها و استفاده بدون تبلیغ به مدت ۶ ماه، نسخه پرمیوم را فعال کنید.',
        ...
        actions: [
          ElevatedButton(
            ...
            child: const Text('فعال‌سازی پرمیوم ۶ ماهه'),
          ),
        ],
      );
    },
